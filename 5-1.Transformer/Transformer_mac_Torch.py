...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, input_Q, input_K, input_V, attn_mask):
        ...
        return nn.LayerNorm(d_model, device=device)(output + residual), attn
...
class PoswiseFeedForwardNet(nn.Module):
    ...
    def forward(self, inputs):
        ...
        return nn.LayerNorm(d_model, device=device)(output + residual)  # [batch_size, seq_len, d_model]
